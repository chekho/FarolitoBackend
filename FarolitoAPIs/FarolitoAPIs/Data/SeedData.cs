        ...
        {            using var context = new FarolitoDbContext(
            ...
            if (!context.Productoproveedors.Any())
            {
                context.Productoproveedors.AddRange(
                    new Productoproveedor { ProveedorId = 9, ComponentesId = 3 },
                    new Productoproveedor { ProveedorId = 9, ComponentesId = 4 },
                    new Productoproveedor { ProveedorId = 9, ComponentesId = 7 },
                    new Productoproveedor { ProveedorId = 9, ComponentesId = 11 },
                    new Productoproveedor { ProveedorId = 9, ComponentesId = 13 },
                    new Productoproveedor { ProveedorId = 10, ComponentesId = 3 },
                    new Productoproveedor { ProveedorId = 10, ComponentesId = 4 },
                    new Productoproveedor { ProveedorId = 10, ComponentesId = 7 },
                    new Productoproveedor { ProveedorId = 10, ComponentesId = 13 },
                    new Productoproveedor { ProveedorId = 11, ComponentesId = 7 },
                    new Productoproveedor { ProveedorId = 11, ComponentesId = 8 },
                    new Productoproveedor { ProveedorId = 11, ComponentesId = 11 },
                    new Productoproveedor { ProveedorId = 12, ComponentesId = 4 },
                    new Productoproveedor { ProveedorId = 12, ComponentesId = 5 },
                    new Productoproveedor { ProveedorId = 12, ComponentesId = 8 },
                    new Productoproveedor { ProveedorId = 13, ComponentesId = 1 },
                    new Productoproveedor { ProveedorId = 13, ComponentesId = 8 },
                    new Productoproveedor { ProveedorId = 13, ComponentesId = 9 },
                    new Productoproveedor { ProveedorId = 13, ComponentesId = 10 },
                    new Productoproveedor { ProveedorId = 13, ComponentesId = 12 },
                    new Productoproveedor { ProveedorId = 14, ComponentesId = 1 },
                    new Productoproveedor { ProveedorId = 14, ComponentesId = 7 },
                    new Productoproveedor { ProveedorId = 14, ComponentesId = 8 },
                    new Productoproveedor { ProveedorId = 14, ComponentesId = 9 },
                    new Productoproveedor { ProveedorId = 14, ComponentesId = 11 },
                    new Productoproveedor { ProveedorId = 14, ComponentesId = 13 },
                    new Productoproveedor { ProveedorId = 15, ComponentesId = 1 },
                    new Productoproveedor { ProveedorId = 15, ComponentesId = 7 },
                    new Productoproveedor { ProveedorId = 15, ComponentesId = 9 },
                    new Productoproveedor { ProveedorId = 15, ComponentesId = 10 },
                    new Productoproveedor { ProveedorId = 15, ComponentesId = 11 },
                    new Productoproveedor { ProveedorId = 15, ComponentesId = 13 },
                    new Productoproveedor { ProveedorId = 16, ComponentesId = 5 },
                    new Productoproveedor { ProveedorId = 16, ComponentesId = 9 },
                    new Productoproveedor { ProveedorId = 16, ComponentesId = 11 },
                    new Productoproveedor { ProveedorId = 16, ComponentesId = 12 }
                );
                context.SaveChanges();
            }
